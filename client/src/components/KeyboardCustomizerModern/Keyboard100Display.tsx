...
import type { Keycap, KeyObject, SwitchItem, KeyConfig } from "../types/types";
...
export type Keyboard100Props = {
  ...
  keyConfigs: KeyConfig[]; // dùng keyConfigs thay cho customKeys/customSwitches
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      const containerWidth =
        keyboardRef.current.parentElement?.offsetWidth || window.innerWidth;
          ...
          return (
            <div className="flex justify-center gap-10">
              ...
              >
                ...
                >
                  {["Insert", "Home", "PgUp", "Delete", "End", "PgDn"].map(
                    (key) => renderKey({ key })
                  )}
                </div>
