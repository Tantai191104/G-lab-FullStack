...
export function Keyboard80Display({
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            const newScale = Math.min(1, (containerWidth - padding - extraGap) / maxRowWidth);
            setScale(newScale);
        };
            ...
            <div className="flex flex-col flex-nowrap">
                {layout80Clustered.map((row, rowIndex) => (
                    <div
                        ...
                        style={{ columnGap: rowIndex === 0 ? 30 * scale : baseSpacing * scale }}
                    >
                        {row.map((cluster, clusterIndex) => (
                            <div
                                ...
                                style={{
                                    ...
                                    rowGap: 8 * scale,
                                    marginLeft: rowIndex === 0 && clusterIndex > 0 ? 27 * scale :
                                        rowIndex === 4 && cluster.some(k => k.key === "Up") ? 60 * scale : 0,
                                }}
                            >
